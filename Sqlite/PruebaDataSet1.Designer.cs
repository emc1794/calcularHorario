...
namespace Sqlite.PruebaDataSet1TableAdapters {
    ...
    public partial class CategoriaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [main].[sqlite_default_schema].[Categoria] WHERE (([id] = @Original_i" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [main].[sqlite_default_schema].[Categoria] ([nombre]) VALUES (@nombre" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [main].[sqlite_default_schema].[Categoria] SET [nombre] = @nombre WHERE ((" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [id], [nombre] FROM [Categoria]";
        ...
        public virtual int Fill(PruebaDataSet1.CategoriaDataTable dataTable) {
        ...
        public virtual PruebaDataSet1.CategoriaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PruebaDataSet1.CategoriaDataTable dataTable = new PruebaDataSet1.CategoriaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PruebaDataSet1.CategoriaDataTable dataTable) {
        ...
        public virtual int Update(string nombre, long Original_id, string Original_nombre) {
            if ((nombre == null)) {
                throw new global::System.ArgumentNullException("nombre");
            }
            else {
        ...
        public virtual int UpdateAll(PruebaDataSet1 dataSet) {
            ...
            try {
                ...
                if ((this._categoriaTableAdapter != null)) {
                    ...
                    this._categoriaTableAdapter.Connection = ((global::System.Data.SQLite.SQLiteConnection)(workConnection));
                    this._categoriaTableAdapter.Transaction = ((global::System.Data.SQLite.SQLiteTransaction)(workTransaction));
                ...
                if ((this._categoriaTableAdapter != null)) {
                    this._categoriaTableAdapter.Connection = ((global::System.Data.SQLite.SQLiteConnection)(revertConnections[this._categoriaTableAdapter]));
